...
const getAllJobs = async (req, res) => {
  ...
  // console.log('totalJobs.............', jobs.length); //job.length always reflect the jobs on this one page.

  const totalJobs = await Job.countDocuments(queryObject);
  // totalJobs is come from the method => count the documents I have for the specific queryObject.

  const numOfPages = Math.ceil(totalJobs / limit);
  // ceil is rounded up

  console.log('totalJobs.............', totalJobs, numOfPages);
